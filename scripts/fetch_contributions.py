...
"""
Fetch real daily contribution counts from GitHub's public
contributions endpoint and write:
...
def build_data(days):
    ...
    cur_len, cur_start, cur_end = (
        compute_current_streak(days)
    )


    long_len, long_start, long_end = (
